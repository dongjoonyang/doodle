$(function() {
     ...
     */   
     $('#summernote').summernote({
        ...
        toolbar: [
            ...
            ['highlight', ['highlight']] // code block
        ],
        callbacks: {
    ...
    /**
     * =======================================
     * 설  명 : summernote preview code block 색상 적용
     * =======================================
     */   
    ...
    $("#boardModBtn").on("click", function(){
        let boardModForm = $("#boardModForm").validate({
            ...
            submitHandler: function(form) {
                ...
                let formData = new FormData($("#boardModForm")[0]);
                
                // 수정시 미리보기가 없을시 return
                let file = $(".upload-thumb-wrap");
                if(file.length !== 0){
                    $.ajax({
                        type : "POST",
    ...
    setEditorContents("#summernote", $("#summerContents").text());
});
